...
class GeneralConfig:
    ...
    hyperparameter_tuning_n_iter: int = 5 # Number of parameter settings that are sampled
    ...
    execution_mode: str = "automatic"  # Options: "automatic", "hybrid"
    # "automatic" = bot places trades automatically
