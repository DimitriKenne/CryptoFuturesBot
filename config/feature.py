...
class FeatureConfig:
    ...
    ema_periods: List[int] = field(default_factory=lambda: [10, 14, 20, 50, 100])
    rsi_periods: List[int] = field(default_factory=lambda: [7, 14, 28, 50])
    bollinger_periods: List[int] = field(default_factory=lambda: [20, 30, 40])
    atr_periods: List[int] = field(default_factory=lambda: [5, 14, 20, 50])
