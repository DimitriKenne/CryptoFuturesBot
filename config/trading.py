...
class TradeExecutionConfig:
    ...
    slippage_tolerance_pct: float = 0.1 # Slippage tolerance as a percentage
...
class EntryFilterConfig:
    ...
    confidence_threshold_long_pct: float = 65 # Confidence threshold for long entries (percentage)
    confidence_threshold_short_pct: float = 65 # Confidence threshold for short entries (percentage)
...
class SLTPConfig:
    ...
    fixed_take_profit_pct: float = 2.0 # Fixed Take Profit as a percentage
    fixed_stop_loss_pct: float = 1.0 # Fixed Stop Loss as a percentage
    alpha_take_profit: float = 1.5 # Multiplier for ATR-based TP
    alpha_stop_loss: float = 2.0 # Multiplier for ATR-based SL
    min_sl_tp_pct: float = 0.1 # Minimum SL/TP distance as a percentage
