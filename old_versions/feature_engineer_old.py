...
class FeatureEngineer:
    ...
    Calculates indicators for lists of periods as defined in FeatureConfig.
    ...
    def __init__(self, config: Optional[FeatureConfig] = None):
        ...
        logger.info("FeatureEngineer initialized with feature configuration from app_config.")
